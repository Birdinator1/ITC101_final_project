...
<div class="container">
  ...
  <div class="card">
    ...
    <?php if ($error): ?>
      <?php
        $is_taunt = str_contains($error, 'Nice try');
        $icon = $is_taunt ? '😏' : '⚠️';
        $cls  = $is_taunt ? 'taunt' : 'error';
      ?>
      <div class="alert <?= $cls ?>">
    ...
    <form method="POST" action="login.php">
      <div class="field">
        ...
        <input type="text" id="username" name="username" placeholder="Enter your username" autocomplete="username" value="<?= htmlspecialchars($_POST['username'] ?? '') ?>"/>
      </div>
      <div class="field">
